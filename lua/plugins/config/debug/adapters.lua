...
local function suggest_build_dir()
  local cwd = vim.fn.getcwd()
  local build_dir = vim.fn.resolve(cwd .. '/compile_commands.json'):match '(.+)/compile_commands.json'
  local suggestion = build_dir and build_dir or cwd
  return suggestion .. '/'
end
